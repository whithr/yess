...
import yessLogo from '@/images/logos/yess-icon.svg'
import skateboardLight from '@/images/skateboardLight.png'
import skateboardDark from '@/images/skateboardDark.png'
          ...
          >
            ...
            <nav className="mt-6">
              <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
                ...
                <MobileNavItem href="/people">People</MobileNavItem>
              </ul>
            </nav>
          </Popover.Panel>
        </Transition.Child>
  ...
  return (
    ...
    >
      ...
      <Image
        ...
        width={32}
        height={32}
        className="hidden h-6 w-6 rotate-90 fill-zinc-700 stroke-zinc-500 transition dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-zinc-400 [@media_not_(prefers-color-scheme:dark)]:fill-blue-400/10 [@media_not_(prefers-color-scheme:dark)]:stroke-blue-500"
      />
    </button>
  )
}
